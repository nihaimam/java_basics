// Wed Apr 26 17:38:47 EDT 2017 : Patched to fix problem with
// realtiveFilName(..) on Windows
...
public class Util{
  ...
  // Determine the file name for linkName which is linked from the
  // file pageFileName.  This method will remove any extraneous ../ or
  // ./ refs which occur in the filename.
  ...
  // List of stopwords used by MySQL with a few modifications. Drawn
  // from the below web address.
  // 
  ...
  public static final String [] STOP_WORDS = {
    ...
    "brief", "but", "by", "c'mon", "c", "came", "can", "can't", "cannot",
    ...
    "do", "does", "doesn't", "doing", "don't", "done", "down",
    "downwards", "during", "each", "edu", "eg", "eight", "either", "else",
    "elsewhere", "enough", "entirely", "especially", "et", "etc", "even",
    "ever", "every", "everybody", "everyone", "everything", "everywhere",
    "ex", "exactly", "example", "except", "far", "few", "fifth", "first",
    ...
    "without", "won't", "wonder", "would", "wouldn't", "yes", "yet",
